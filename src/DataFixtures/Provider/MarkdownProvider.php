 ...
 */
class MarkdownProvider extends Lorem
{
    /**
     * @return string
     */
    public static function markdown()
    {
        ...
        } while (self::randomDigit() > 3 || count($parts) < 3);
     ...
     * @return string
     */
    public static function markdownP($maxNbChars = 350)
    {
     ...
     * @return string
     */
    public static function markdownBulletedList($nb = 4)
    {
     ...
     * @return string
     */
    public static function markdownNumberedList($nb = 4)
    {
     ...
     * @return string
     */
    public static function markdownCode($maxNbChars = 400)
    {
